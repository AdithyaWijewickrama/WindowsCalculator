...
public abstract class Calculus {
    ...
    public Calculus(TokenList fx, TokenType type, TokenList gx) {
        System.out.println(type.name()+"++++++++++++++++");
        System.out.println(fx.toLocalString()+" "+type.name()+" "+gx.toLocalString());
        this.fx = fx;
        this.gx = gx;
        this.type = type;
    }

    public Calculus(TokenList fx, TokenType type) {
        System.out.println(type.name()+"++++++++++++++++");
