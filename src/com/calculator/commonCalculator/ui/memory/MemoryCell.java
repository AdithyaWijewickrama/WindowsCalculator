...
public abstract class MemoryCell extends javax.swing.JPanel {
    ...
    public static Number INCREMENT = Number.parseNumber(0);
    public static int CURRENT_CELL_COUNT = 0;

    /**
     * Creates new form HistoryCell
     */
    public MemoryCell(Number value) {
        CURRENT_CELL_COUNT++;
        initComponents();
        this.value = value;
        INCREMENT = value;
    ...
    public void substractValue(Number n) {
    ...
    public abstract void memoryItemClicked(Number num);
