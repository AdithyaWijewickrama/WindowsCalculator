...
import static com.home.Converts.forgetFocus;
import static com.home.Converts.getComboModel;
import static com.home.Converts.getFocus;
import static com.home.Graphical.getUIColor;
import static com.home.Graphical.getUIColorType;
...
public final class FrontFrame extends javax.swing.JFrame {
    ...
    public GraphingPanel graphingPanel;
    ...
    public FrontFrame() {
        ...
        functionPanel = new FunctionPanel() {
            ...
            public void setFunctions(List funcs) {
                graphingPanel.functions = (ArrayList<Object[]>) funcs;
            }
...
//        calculator.remove(showBar);
    ...
    private void initComponents() {
        ...
        autoSave.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.SHIFT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        ...
        AOTop.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_MASK));
        ...
        setPreferredSize(new java.awt.Dimension(338, 530));
        setState(2);

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${shape.bounds.width}"), this, org.jdesktop.beansbinding.BeanProperty.create("size"));
