...
import static com.home.FrontFrame.APP_HOVER;
import static com.home.MemoryPanel.calTxt;
...
public class HistryPanel extends javax.swing.JPanel {
    ...
    public static void main(String[] args) {
        test f = new test();
        HistryPanel hp = new HistryPanel();
