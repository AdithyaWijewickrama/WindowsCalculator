...
import expression.AbsoluteValue;
import expression.Ceiling;
import expression.Cosecant;
import expression.Cosine;
import expression.Cotangent;
import expression.Difference;
import expression.Floor;
import expression.Function;
import expression.Log;
import expression.Modulo;
import expression.NthRoot;
import expression.Number;
import expression.Power;
import expression.Product;
import expression.Quantity;
import expression.Quotient;
import expression.Secant;
import expression.Sine;
import expression.SquareRoot;
import expression.Sum;
import expression.Tangent;
